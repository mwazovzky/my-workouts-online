...
Workout tracking application — Laravel 12 / Inertia v2 / Vue 3 / Tailwind v3 / MySQL.
...
| [Workout Logging](features/workout-logging.md) | Start, complete, repeat, delete workout logs |
