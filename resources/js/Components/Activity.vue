        ...
        <CardHeader class="pb-3 border-b">
            <div class="flex items-center justify-between gap-4">
                ...
                <div v-if="editable" class="flex items-center gap-1 bg-muted/50 p-1 rounded-md">
                    <Button @click="addSet" variant="outline" size="sm" class="h-8">
                        <Plus class="h-4 w-4" />
                    </Button>
                    <Button @click="save" size="sm" class="h-8 active:scale-95 active:shadow-inner transition-transform">
                        <Save class="h-4 w-4" />
                    </Button>
                    <Button @click="removeActivity" variant="destructive" size="sm" class="h-8">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-end gap-2 pb-1">
                    ...
                    <div class="flex gap-3 flex-1">
                        <div class="flex-1">
                            <label class="text-xs text-gray-500 dark:text-gray-400 text-right block pr-3">Reps</label>
                        </div>
                        <div class="flex-1">
                            <label class="text-xs text-gray-500 dark:text-gray-400 text-right block pr-3">Weight</label>
                        </div>
                    </div>
                    <div class="w-8"></div>
                </div>
