    ...
    <PageLayout>
      <div class="space-y-4">
        ...
        <Card
          ...
          class="border-primary/15 bg-gradient-to-r from-primary/5 via-accent/40 to-background p-4 shadow-sm"
        >
              ...
              <Card class="p-3">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                  <div class="min-w-0 flex-1">
                    ...
                    <div
                      class="mt-1 flex flex-col gap-1 text-sm text-muted-foreground sm:flex-row sm:flex-wrap sm:gap-4"
                    >
